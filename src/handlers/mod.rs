...
use crate::handlers::dto::{
    Contact, Entrepreneur, Invoice, InvoiceRow, InvoiceWithRows, NewContact, NewEntrepreneur, NewInvoice, NewInvoiceRow,
};
use crate::logic;
...
pub async fn get_entrepreneur(entrepreneur_id: web::Path<u32>, ctx: web::Data<RequestContext>) -> impl Responder {
...
pub async fn get_invoice(invoice_id: web::Path<u32>, ctx: web::Data<RequestContext>) -> impl Responder {
...
pub async fn get_invoice_with_rows(invoice_id: web::Path<u32>, ctx: web::Data<RequestContext>) -> impl Responder {
...
pub async fn get_contact(contact_id: web::Path<u32>, ctx: web::Data<RequestContext>) -> impl Responder {
...
pub async fn list_contacts(ent_id: web::Path<u32>, ctx: web::Data<RequestContext>) -> impl Responder {
...
pub async fn list_invoices(ent_id: web::Path<u32>, ctx: web::Data<RequestContext>) -> impl Responder {
...
pub async fn list_invoice_rows(invoice_id: web::Path<u32>, ctx: web::Data<RequestContext>) -> impl Responder {
...
pub async fn insert_entrepreneur(entrepreneur: web::Json<NewEntrepreneur>, ctx: web::Data<RequestContext>) -> impl Responder {
...
pub async fn insert_contact(contact: web::Json<NewContact>, ctx: web::Data<RequestContext>) -> impl Responder {
...
pub async fn insert_invoice(invoice: web::Json<NewInvoice>, ctx: web::Data<RequestContext>) -> impl Responder {
...
pub async fn insert_invoice_row(row: web::Json<NewInvoiceRow>, ctx: web::Data<RequestContext>) -> impl Responder {
...
pub async fn update_entrepreneur(entrepreneur: web::Json<Entrepreneur>, ctx: web::Data<RequestContext>) -> impl Responder {
...
pub async fn update_contact(contact: web::Json<Contact>, ctx: web::Data<RequestContext>) -> impl Responder {
...
pub async fn update_invoice(invoice: web::Json<Invoice>, ctx: web::Data<RequestContext>) -> impl Responder {
...
pub async fn update_invoice_row(row: web::Json<InvoiceRow>, ctx: web::Data<RequestContext>) -> impl Responder {
...
pub async fn delete_entrepreneur(id: web::Path<u32>, ctx: web::Data<RequestContext>) -> impl Responder {
...
pub async fn delete_invoice_row(id: web::Path<u32>, ctx: web::Data<RequestContext>) -> impl Responder {
